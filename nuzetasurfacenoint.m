...
c = 1;
    for b = 0.5:0.5:5
[tout, yout] = ode15s(@(t,x) DE(t,x,[kq, kminus, kp, kplus, muminus, thetamu, kaplus, muplus, kaminus, kbplus, kbminus,kr,kf,thetazeta,1e-3,b,thetav,1,a,thetamuv,thetaa,thetazetav,thetazetamu, kgplus, kgminus,A]), tspan, yinit);
[y, x] = max(yout(:,11));
z(c,d) = y;
c = c+1;
    end
...
title("\zeta vs. \nu Surface Plot", "Peak Concentration of α† without Internalization")