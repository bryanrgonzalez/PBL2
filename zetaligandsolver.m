...
title('Parameter Sweep of \zeta', 'Total Concentration of Activated Receptor vs. Time with Internalization');
k = k+1;
end;
...
title('Parameter Sweep of \zeta', 'Concentration of α† vs. Time with Internalization');
yolo = yout(:,11);
...
title('\zeta Parameter vs. Peak [α†]', 'with Internalization')
