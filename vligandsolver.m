...
ylim([0 0.4])
Legend{k}=strcat('\nu=', num2str(i));
title('Parameter Sweep of \nu', 'Total Concentration of Activated Receptor vs. Time with Internalization');
k = k+1;
end;
...
ylim([0 2.3])
Legend2{r}=strcat('\nu= ', num2str(i));
title('Parameter Sweep of \nu', 'Concentration of α† vs. Time with Internalization');
yolo = yout(:,11);
...
title('\nu Parameter vs. Peak [α†]', 'with Internalization')
